...
***** TODO add team name data from the team_members view
***** TODO understand what to do with the js tooltip
***** TODO run `rake teaspoon` from `rake`
***** TODO do the actual subscription
****** TODO inject a fake channel (minimal for the moment, no stupid mock)
****** TODO test the js
***** TODO Fix the port conflict with rails server
