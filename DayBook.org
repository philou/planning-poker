...
**** TODO move the 'remaining' out of the js
**** TODO pluralize the 'n seconds' in the countdown with %!S
**** TODO add 'Z' to the sent date
** TODO smell ? sleep in features ? could we speed that up ?
