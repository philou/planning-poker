...
#
# Matching files
# By default Teaspoon will look for files that
# match _spec.{js,js.coffee,.coffee}. Add a filename_spec.js file in your spec
# path and it'll be included in the default suite automatically. If you want to
