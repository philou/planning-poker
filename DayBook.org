...
*** TODO can we factorize the #team-vote-state ?
**** almost 3 languages (ruby, coffee, css)
**** not sure it's possible
**** not sure the error reporting will be any better
**** constant in js will give undefined !
**** could we had something to make sure the #id exists in the code, to make sure it gets caught
...
*** DONE try ClimateCode
*** DONE does the #TODO hints get listed ? YES
*** TODO plug coverage from travis to code climate
*** TODO add badges to readme
*** TODO Install chrome extension to CodeClimate
*** TODO Is there any value in Rubocop and guard-rubocop ? It's already done in CodeClimate, guard could be cool
